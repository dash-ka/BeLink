...
def filter_collection(args, collection):
    ...
    with open(os.path.join(args.dictionary_dir, "kb.json"), encoding="utf-8") as f:
        kb = json.load(f)
...
def main():
    ...
    parser.add_argument('--dictionary_dir',required=True,type=str,help='Path to the disambiguated terminology.')
    ...
    if args.filter_test:
        ...
        save_bioc_docs(gnormplus_test_docs, output_dir / test_file)
