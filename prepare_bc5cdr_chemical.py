...
def filter_collections(args, collection):
        ...
        print("Loading and reformatting CTD-Chemical...")
...
def main():
    ...
    parser.add_argument('--dictionary_dir',required=True,type=str,help='Path to the folder with disambiguated terminology')
    ...
    #save_bioc_docs(train_docs_bc5cdr, output_dir / "bc5cdr_chem_train.bioc.xml.gz" )
    #save_bioc_docs(val_docs_bc5cdr, output_dir / "bc5cdr_chem_val.bioc.xml.gz")
    save_bioc_docs(train_docs_bc5cdr + val_docs_bc5cdr, output_dir / "bc5cdr_chem_traindev.bioc.xml.gz" )
